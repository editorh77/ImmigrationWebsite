...
$status=1;
$query=mysqli_query($con,"insert into tblsubcategory(Category,Subcategory,SubCatDescription,Is_Active) values($category,'$subcatname','$subcatdescription',$status)");
if($query)
{
...
<head>
    ...
    <title><?php include_once $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?> | Add Sub Category</title>
