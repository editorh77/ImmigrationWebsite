...
<head>
    ...
    <!-- App title -->
    <title><?php include_once $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?> | Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="index.html" class="logo"><span><?php include_once $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?><span>Admin</span></span><i
                        ...
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        <a href=""><?php include_once $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?></a>
                                    </li>
                                    <li>
                                        <a href="#">Admin</a>
                                    </li>
