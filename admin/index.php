...
<head>
    ...
    <!-- App title -->
    <title><?php include $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?> | Admin Panel</title>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="wrapper-page">
                        ...
                        <div class="m-t-40 account-pages">
                            <div class="text-center account-logo-box" style="background: rgb(0,67,66);
background: linear-gradient(0deg, rgba(0,67,66,1) 0%, rgba(0,255,164,1) 100%);">
                                <h2 class="text-uppercase">
                                    <a href="index.html" class="text-success">
                                        <span style="color:#ffffff">HYImmigration</span>
                                    </a>
                                </h2>
                            ...
                            <div class="account-content">
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group account-btn text-center m-t-10">
                                        <div class="col-xs-12">
                                            <button class="btn w-md btn-bordered btn-success waves-effect waves-light"
