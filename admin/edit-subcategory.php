...
{
$id=intval($_GET['subcat']);
$cat=$_POST['category'];
$subcatname=$_POST['subcategory'];
$subcatdescription=$_POST['sucatdescription'];
$query=mysqli_query($con,"update tblsubcategory set Category=$cat,Subcategory='$subcatname',SubCatDescription='$subcatdescription' where id='$id'");
if($query)
{
...
<head>
    ...
    <title><?php include_once $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?>  | Edit Sub Category</title>
