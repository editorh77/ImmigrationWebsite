...
if(isset($_POST['update']) && isset($_GET['pagetype']))
{
$pagetype=$_GET['pagetype'];
$pagetitle=$_POST['pagetitle'];
$pagedetails=$_POST['pagedescription'];

$query=mysqli_query($con,"update tblpages set PageTitle='$pagetitle',PageDescription='$pagedetails' where PageName='$pagetype'");
if($query)
{
...
<head>
    ...
    <!-- App title -->
    <title><?php include_once $_SERVER['DOCUMENT_ROOT']."/logic.php"; echo htmlentities(getTitle()); ?> | About us Page</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php
$pagetype= $_GET['pagetype'];
$query=mysqli_query($con,"select PageTitle,PageDescription from tblpages where PageName='$pagetype'");
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <textarea class="summernote" name="pagedescription"
                                                        required><?php echo htmlentities($row['PageDescription'])?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
